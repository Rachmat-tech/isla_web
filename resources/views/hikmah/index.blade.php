            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="icon-box" data-aos="zoom-in-left">
                  ...
                  <p class="description">Para Alumni ISLA UH dapat mencari lowongan pekerjaan yang dibuka oleh sesama Alumni ISLA UNHAS</p>
                </div>
              </div>
              <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
                <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="100">
                  <div class="icon"><i class="bi bi-book" style="color: #e9bf06;"></i></div>
                  <h4 class="title"><a href="">Bantuan Para Alumni</a></h4>
                  <p class="description">Mahasiswa dan Alumni Kelautan berkesempatan mendapatkan bantuan baik materil maupun immateri</p>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 mt-5">
                <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="300">
                  ...
                  <p class="description">Kesempatan untuk bekerja sama dengan sesama para alumni ISLA UH</p>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 mt-5">
                <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="400">
                  ...
                  <p class="description">Para alumni ISLA UH bisa mendapatkan jaringan koneksi yang luas dengan para alumni yang tersebar di seluruh Indonesia bahkan Dunia</p>
                </div>
              </div>
              <div class="col-lg-4 col-md-6 mt-5">
                <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="500">
                  <div class="icon"><i class="bi bi-clock" style="color: #4680ff;"></i></div>
                  <h4 class="title"><a href="">Enggagement</a></h4>
                  <p class="description">Para alumni ISLA UH bisa menjaga hubungan jangka panjang dengan teman-teman alumni binusian juga dari mana pun</p>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="box" data-aos="zoom-in">
              ...
              <img src="../assets/img/features-1.png" alt="" width="60%" height="50%">
          ...
          <div class="col-lg-6 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="200">
              ...
              <img src="../assets/img/features-2.png" alt="" width="60%" height="50%">
          ...
          <div class="col-lg-6 text-center">
            <div class="row" data-aos="zoom-out">
              <div style="display: flex; justify-content: center">
                <h1>DATA STATISTIK ALUMNI ISLA UH</h3>
              </div>
              <div class="col-lg-6 text-center">
                <h1>800+</h1>
                <p>Total Alumi</p>
              </div>
              <div class="col-lg-6 text-center" style="border-left: 2px solid #c5c079;">
                <h1>800+</h1>
                <p>Alumni Aktif di Media Sosial</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4" data-aos="fade-right">
            <div class="info">
              <img src="../assets/img/KTA.jpeg" alt="" width="90%" height="90%">
            </div>
          </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group mt-3">
                ...
                <input type="text" class="form-control" name="date" id="date" placeholder="Tanggal Lahir" required>
              </div>
              <div class="form-group mt-3">
                <label for="form-label">Angkatan</label>
                <input type="text" class="form-control" name="subject" id="nim" placeholder="Angkatan" required>
              </div>
              <br>
              <div class="row">
                <div class="col-md-6 form-group">
                  <label for="form-label">Tahun Lulus</label>
                  <input type="email" class="form-control" name="email" id="email" placeholder="Tahun Lulus" required>
                </div>
                {{-- <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="number" class="form-control" name="number" id="kontak" placeholder="No. Telp" required>
                </div> --}}
              </div>
              <div class="my-3">
