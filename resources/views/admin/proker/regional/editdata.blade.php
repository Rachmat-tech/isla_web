                    ...
                    <div class="col-8">
                        <form action="{{ route('editregional', $data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($data->foto)
                                    <img src="{{ asset('storage/photos/regional-img/' . $data->foto) }}"
                            ...
                            <a href="{{ route('regional') }}" class="btn btn-secondary">Cencel</a>
...
@push('scripts')
    ...
    <script src="https://cdn.tiny.cloud/1/wsq6tbauqun7rq24d7d6wto27qs6qjlepz3f1whznzduu2rq/tinymce/5/tinymce.min.js">
    </script>
    <script>
        var editor_config = {
            path_absolute: "/",
