...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Berita Kelautan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <a href="{{ route('tambahberita') }}" class="btn btn-success mb-2">Tambah +</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img class="img-berita" style="width: 80px"
                                        src="{{ asset('storage/photos/beritaKelautan-img/' . $item->foto) }}"
                                        alt="">
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('editberita', $item->id) }}" class="btn btn-info">Edit</a>
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                        data-title="{{ $item->judul }}" data-isi="{{ $item->isi }}"
                                        class="btn btn-warning btn-show-berita">Detail</button>
                                    <a href="{{ route('deleteberita', $item->id) }}" class="btn btn-danger delete"
