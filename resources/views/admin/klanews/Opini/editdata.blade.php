        ...
        <div class="container-fluid">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-8">
                        <form action="{{ route('updateopini',$data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="mb-3">
                                <label class="form-label">Input Foto</label>
                                @if ($data->foto)
                                <img src="{{ asset('storage/photos/opini-img/' . $data->foto) }}" class="img-preview img-fluid mb-3 col-sm-4 d-block">
                                @else
                            ...
                            <a href="{{ route('opini') }}" class="btn btn-secondary">Cencel</a>
