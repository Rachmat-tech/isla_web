        ...
        <div class="container-fluid">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-8">
                        <form action="{{ route('updatepengurus',$data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($data->foto)
                                <img src="{{ asset('storage/photos/pengurusWilayah-img/' . $data->foto) }}" class="img-preview img-fluid mb-3 col-sm-4 d-block">
                                @else
                            ...
                            <a href="{{ route('pengurus') }}" class="btn btn-secondary">Cencel</a>
